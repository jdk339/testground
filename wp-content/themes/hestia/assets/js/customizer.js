( function( $ ) {
	...
	wp.customize( 'accent_color', function( value ) {
		value.bind( function( newval ) {
			...
			$( '.btn.btn-primary, .card .header-primary, input#searchsubmit, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce ul.products li.product .onsale, .woocommerce span.onsale, article .section-text a, .woocommerce .button:not(.btn-just-icon), .woocommerce div.product .woocommerce-tabs ul.tabs.wc-tabs li.active a, .work .portfolio-item:nth-child(6n+1) .label, .pagination span.current').css('background-color', newval);
