	...
	$('body').on('added_to_cart',function(){
		...
		if( typeof $( 'section.products a.add_to_cart_button.added' ) !== 'undefined' ) {
			if( typeof $( 'section.products a.add_to_cart_button.added' ).parent() !== 'undefined' ) {
				$('section.products a.add_to_cart_button.added').parent().append('<div class="hestia-view-cart-wrapper"><a href="' + hestiaViewcart.view_cart_link + '" class="added_to_cart wc-forward">' + hestiaViewcart.view_cart_label +  '</a></div>');
			}
		}
