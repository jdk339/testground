...
function hestia_big_title_customize_register( $wp_customize ) {
	...
	if ( empty( $hestia_slider_content ) ) {
		...
		$wp_customize->get_setting( 'hestia_big_title_title' )->default = esc_html__( 'Change in customizer', 'hestia' );
		$wp_customize->get_setting( 'hestia_big_title_text' )->default = esc_html__( 'Change this subtitle in customizer.', 'hestia' );
		$wp_customize->get_setting( 'hestia_big_title_button_text' )->default = esc_html__( 'Change in customizer', 'hestia' );
